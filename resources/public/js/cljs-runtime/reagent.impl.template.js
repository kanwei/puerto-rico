...
var G__38253 = o;
reagent.impl.template.goog$module$goog$object.set(G__38253,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__38562__i < G__38562__a.length) {G__38562__a[G__38562__i] = arguments[G__38562__i + 0]; ++G__38562__i;}
  args = new cljs.core.IndexedSeq(G__38562__a,0,null);
} 
...
var G__38269 = o;
reagent.impl.template.goog$module$goog$object.set(G__38269,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__38565__i < G__38565__a.length) {G__38565__a[G__38565__i] = arguments[G__38565__i + 0]; ++G__38565__i;}
  args = new cljs.core.IndexedSeq(G__38565__a,0,null);
} 
...
var G__38283 = props;
var G__38283__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38283,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__38283);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38283__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__38302 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38302,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__38302;
}
})(),id_class);
...
var temp__5825__auto___38567 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___38567)){
var d_38568 = temp__5825__auto___38567;
if((d_38568 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_38568.s}));
} else {
...
var G__38321 = (cljs.core.count(argv) - first_child);
switch (G__38321) {
case (0):
...
var vec__38356 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38356,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38356,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38356,(2),null);
...
var temp__5829__auto___38570 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___38570 == null)){
} else {
var key_38571 = temp__5829__auto___38570;
(jsprops.key = key_38571);
}
...
var temp__5829__auto___38572 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___38572 == null)){
} else {
var key_38573 = temp__5829__auto___38572;
(jsprops.key = key_38573);
}
...
var temp__5829__auto___38574 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___38574 == null)){
} else {
var key_38575 = temp__5829__auto___38574;
(jsprops.key = key_38575);
}
...
var temp__5829__auto___38576 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___38576 == null)){
} else {
var key_38577 = temp__5829__auto___38576;
(jsprops.key = key_38577);
}
...
var temp__5829__auto___38578 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___38578 == null)){
} else {
var key_38579 = temp__5829__auto___38578;
(jsprops.key = key_38579);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38551_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__38551_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__38552 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38552,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38552,(1),null);
...
break;
default:
var G__38581 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__38582 = compiler;
v = G__38581;
compiler = G__38582;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template38558 = (function (opts,id,fn_to_element,parse_fn,meta38559){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template38558.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_38560,meta38559__$1){
var self__ = this;
var _38560__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template38558(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta38559__$1));
}));

(reagent.impl.template.t_reagent$impl$template38558.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_38560){
var self__ = this;
var _38560__$1 = this;
return self__.meta38559;
}));

(reagent.impl.template.t_reagent$impl$template38558.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template38558.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template38558.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template38558.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template38558.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template38558.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta38559","meta38559",202342305,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template38558.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template38558.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template38558");

(reagent.impl.template.t_reagent$impl$template38558.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template38558");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template38558.
 */
reagent.impl.template.__GT_t_reagent$impl$template38558 = (function reagent$impl$template$__GT_t_reagent$impl$template38558(opts,id,fn_to_element,parse_fn,meta38559){
return (new reagent.impl.template.t_reagent$impl$template38558(opts,id,fn_to_element,parse_fn,meta38559));
});
...
return (new reagent.impl.template.t_reagent$impl$template38558(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
