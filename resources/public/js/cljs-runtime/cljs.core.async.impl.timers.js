...
var i_30751 = (0);
while(true){
if((i_30751 < arr.length)){
(arr[i_30751] = null);

var G__30757 = (i_30751 + (1));
i_30751 = G__30757;
continue;
} else {
}
...
var i_30815 = (self__.level + (1));
while(true){
if((i_30815 <= (new_level + (1)))){
(update[i_30815] = self__.header);

var G__30820 = (i_30815 + (1));
i_30815 = G__30820;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_30825 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_30825[i]));
} else {
x__$2.forward.push((((i < links_30825.length))?(links_30825[i]):null));
}

if((i < links_30825.length)){
(links_30825[i] = x__$2);
} else {
links_30825.push(x__$2);
}
...
var i_30834 = (0);
while(true){
if((i_30834 <= self__.level)){
var links_30839 = (update[i_30834]).forward;
if((x__$1 === (((i_30834 < links_30839.length))?(links_30839[i_30834]):null))){
(links_30839[i_30834] = (x__$1.forward[i_30834]));

var G__30841 = (i_30834 + (1));
i_30834 = G__30841;
continue;
} else {
var G__30844 = (i_30834 + (1));
i_30834 = G__30844;
continue;
}
} else {
...
var G__30857 = nx;
var G__30858 = (level__$1 - (1));
x = G__30857;
level__$1 = G__30858;
continue;
} else {
var G__30860 = x;
var G__30861 = (level__$1 - (1));
x = G__30860;
level__$1 = G__30861;
continue;
}
